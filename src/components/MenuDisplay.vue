...
export default {
  ...
  computed: {
    ...
    table1Data() {
      return this.sortedData.slice(0, this.halfData);
    },
    table2Data() {
      return this.sortedData.slice(this.halfData, this.data.length);
    },
    sortedData() {
      let sortedData = [];
  ...
  methods: {
    updateSortBy(byThis) {
      ...
      console.log(
        `sortBy: ${this.sortBy}, flipDirection: ${this.flipDirection}`
      );
    },
    columnHeight() {
      setTimeout(() => {
            ...
            .then((data) => {
              ...
              if (obj !== {}) {
                ...
                data1o1.forEach((item) => {
                  ...
                  if (
                    this.product === "concentrate" ||
                    this.product === "cartridge"
                  ) {
                    if (item.weight === "0 G") {
                      item.weight = "1 G";
                ...
                uplifting = typeThc.uplifting.sort((a, b) =>
                  a.thc > b.thc ? 1 : -1
                );
                balanced = typeThc.balanced.sort((a, b) =>
                  a.thc > b.thc ? 1 : -1
                );
                relaxing = typeThc.relaxing.sort((a, b) =>
                  a.thc > b.thc ? 1 : -1
                );
                typeMissing = typeThc.typeMissing.sort((a, b) =>
                  a.thc > b.thc ? 1 : -1
                );
                ...
                let arraySecondHalf = data1o1.slice(
                  halfwayThrough,
                  data1o1.length
                );
                ...
                if (this.screensSetting === "1 of 1") {
                  ...
                  this.data = data1o2;
                } else if (this.screensSetting === "2 of 2") {
                  this.data = data2o2;
                }
              }
            });
